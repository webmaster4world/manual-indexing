...
class App_Form_AccessoriForm extends Zend_Form  
{ 
    ...
    { 		        
    	...
    	foreach ($menu_rows as  $info_row) {        	
        	$menu_rows_array[$info_row['id']] = $info_row['nome'];
        }
        
        parent::__construct($options);
        $this->setName('Nuovo Accessorio');
        $this->setAttrib('enctype', 'multipart/form-data');
           
        $nome = new Zend_Form_Element_Text('nome');
        $nome->setLabel('Nome accessorio:')
        ...
        $menu = new Zend_Form_Element_Multiselect('oggetto_id');
        $menu->setLabel('Seleziona oggetto d\'appartenenza:')
