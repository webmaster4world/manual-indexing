...
tinyMceWysiwygSetup.prototype =
{
    ...
    {
        var plugins = 'safari,pagebreak,style,layer,table,advhr,advimage,emotions,iespell,media,searchreplace,contextmenu,paste,directionality,fullscreen,noneditable,visualchars,nonbreaking,xhtmlxtras,ldmediaplayer';
        ...
        var settings = {
            ...
            theme_advanced_buttons4 : 'insertlayer,moveforward,movebackward,absolute,|,styleprops,|,cite,abbr,acronym,del,ins,attribs,|,visualchars,nonbreaking,pagebreak,|,ldmediaplayer',
            ...
            extended_valid_elements : 'video[src|width|height|id|class|style|rel|alt|title],audio[src|width|height|id|class|style|rel|alt|title]',
