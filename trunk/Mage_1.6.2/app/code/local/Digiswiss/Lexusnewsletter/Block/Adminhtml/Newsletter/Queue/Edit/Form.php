...
class Digiswiss_Lexusnewsletter_Block_Adminhtml_Newsletter_Queue_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
    ...
    protected function _prepareForm()
    {
        ...
        if($queue->getQueueStatus() == Mage_Newsletter_Model_Queue::STATUS_NEVER) {
            ...
            if (!Mage::app()->isSingleStoreMode()) {
				...
				/* Hackpoint */
     		$fieldset->addField('channels','select',array(
         'name'          => 'channel',
         'label'         => Mage::helper('newsletter')->__('Subscribers From'),
         //'image'         => $this->getSkinUrl('images/grid-cal.gif'),
         'required'      => true,
         'values'        => array(
                            array("label"=>"","value"=>""),
                            array("label"=>"Alle","value"=>"is_subscribed"),
                            array("label"=>"Modelle","value"=>"news_modelle"),
                            array("label"=>"Technologie", "value"=>"news_technologie"),
                            array("label"=>"Unternehmen", "value"=>"news_unternehmen"),
                            array("label"=>"Nachhaltigkeit", "value"=>"news_nachhaltigkeit"),
                            array("label"=>"Events", "value"=>"news_events")
                            )//,
         //'value'         => array("Modelle","Technologie","Unternehmen","Nachhaltigkeit","Events")
         //'value'         => $queue->getChannel() // 2get from Template, if at all...
         ));
