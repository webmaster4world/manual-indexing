...
class Digiswiss_Soapsync_Block_Adminhtml_Fototheke_Soap_Generate extends Mage_Adminhtml_Block_Abstract
{
    public function getProfile()
    {
        //return Mage::registry('soapsync_fototheke_model');
        return Mage::getModel('soapsync/fototheke');
    }
...
//                     $importIds = $batchImportModel->getIdCollection();
                    $importIds = $batchModel->getIdCollection(true);
...
function execImportData() {
    if (importData.length == 0) {
        ...
        new Ajax.Request("' . $this->getUrl('*/*/generateEnd', array('id' => $batchModel->getId())) .'", {
            method: "post",
...
function sendImportData(data) {
    ...
    new Ajax.Request("'.$this->getUrl('*/*/batchGenerate').'", {
      method: "post",
      parameters: data,
