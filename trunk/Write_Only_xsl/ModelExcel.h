#ifndef MODEL_EXCEL_WRITTELN
#define MODEL_EXCEL_WRITTELN

#define MODEL_QT_RUNNING
...
window read excel as odbc 


####################### usage on C++ or QT Models  #######################################
...
int main (int argc, char **args)
{
  ...
  miniexcel(0,0) = QVariant("La strega scrive");
  miniexcel(1,0) = "Item2:";
  miniexcel(2,0) = "Sum = ";
...
aHR0cDovL3d3dy5jb2RlcHJvamVjdC5jb20vS0IvY3BwL21pbmlleGNlbC5hc3B4
  ...
  /********************************************************
	...
	class ExcelCell:public excelValueAttributes{
		...
		public:
            ...
            /*  QT  QVariant operator */
            ExcelCell& operator=(const QVariant v);
...
#endif  /* #ifndef MODEL_EXCEL_WRITTELN */
