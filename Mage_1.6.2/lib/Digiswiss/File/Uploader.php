...
//         }
    ...
    public function save($destinationFolder, $newFileName=null)
    {
        ...
        $fileName = ( isset($newFileName) ) ? $newFileName : self::getCorrectFileName($this->_file);
        ...
        $folder = ($this->_sourceFolder !== '') ? DS . $this->_sourceFolder . DS : '/' ;
        $srcFile = $this->_sourcePath . $folder . $this->_file;
        $result = copy(Mage::getBaseDir('media') . DS . $srcFile, $destFile);
    ...
    private function _setUploadName($fileName)
    {
