...
void XMLTextEdit::opendFile(  const QString fixfile ) {
...
void XMLTextEdit::opendFile() {
	
	
  const QString fileName = QFileDialog::getOpenFileName(this,tr("Open Image"),QDir::homePath());
  opendFile(fileName);
...
TContext->addAction(tr("Open File" ), this , SLOT( opendFile() ) );
return TContext;
}
