...
class App_Form_NuoviLavoroForm extends Zend_Form  
{ 
    public function __construct($options = null) 
    {     	
        parent::__construct($options);
        $this->setName('Nuova lavoro');

        $id = new Zend_Form_Element_Hidden('id');
        
        $titolo = new Zend_Form_Element_Text('offerta');
        $titolo->setLabel('Titolo offerta:')
        ...
        $sede = new Zend_Form_Element_Text('settore');
        $sede->setLabel('Settore:')
              ->setRequired(true)->addFilter('StripTags')
              ->addFilter('StringTrim')
              ->addValidator('NotEmpty', false, array('messages' => array('isEmpty' => '&uarr; Il campo è obbligatorio &uarr;')));

        $durata = new Zend_Form_Element_Text('luogo');
        $durata->setLabel('Luogo:')
              ->setRequired(true)->addFilter('StripTags')
              ->addFilter('StringTrim')
              ->addValidator('NotEmpty', false, array('messages' => array('isEmpty' => '&uarr; Il campo è obbligatorio &uarr;')));
